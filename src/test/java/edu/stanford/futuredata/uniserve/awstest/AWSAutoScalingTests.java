...
public class AWSAutoScalingTests {
    ...
    public void testBasicAutoScaling() throws InterruptedException {
        ...
        DataStore<KVRow, KVShard> dataStore = new DataStore<>(new AWSDataStoreCloud("uniserve-data"), new KVShardFactory(), Path.of("/var/tmp/KVUniserve","shard"), zkHost, zkPort, "127.0.0.1", 8300, -1, false
        );
