...
public class KVStoreTests {
    ...
    public void testAddingServers() throws InterruptedException {
        ...
        DataStore<KVRow, KVShard>  dataStoreOne = new DataStore<>(new AWSDataStoreCloud("uniserve-data"),
        ...
        DataStore<KVRow, KVShard>  dataStoreTwo = new DataStore<>(new AWSDataStoreCloud("uniserve-data"),
